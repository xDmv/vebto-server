...
class CssThemeGenerator
{
    ...
    public function __construct(Settings $settings)
    {
        ...
        $this->variables = config('vebto.appearance.variables');
    }
    ...
    public function generate()
    {
        $dirs = [
            ...
            base_path('../client/src/vebto-client')
        ];
    ...
    private function getSassVariableFileContents()
    {
        ...
        $dirs = [base_path('../client/src/'), base_path('../client/src/vebto-client')];
    ...
    private function addMaterialSelectorsToGroupedVariables($grouped)
    {
        ...
        if (array_search('wp-bg-color-500', $this->variables) > -1) {
            $grouped['wp-bg-color-600']['background-color'][] = [
                'selector' => '.auth-page .auth-panel',
            ];

            $grouped['wp-bg-color-500']['background-color'][] = [
                'selector' => '.auth-page',
            ];

            $grouped['wp-bg-color-400']['border-color'][] = [
                'selector' => '.auth-page .auth-panel, .auth-page > .auth-panel .input-container > input',
            ];
